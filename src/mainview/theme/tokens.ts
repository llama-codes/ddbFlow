export const darkTheme = {
  bg: {
    ...
    tableKeyAccent: "bg-blue-400/10",
    gsiAccent: "bg-emerald-400/10",
    lsiAccent: "bg-cyan-400/10",
  },
  text: {
    ...
    tableKey: "text-blue-400",
    gsi: "text-emerald-400",
    lsi: "text-cyan-400",
  },
  border: {
    ...
    tableKeyAccent: "border-blue-400/20",
    gsiAccent: "border-emerald-400/20",
    lsiAccent: "border-cyan-400/20",
  },
  dot: {
